    ...
    public class AdminPanelController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Practitioner != null ? 
                          ...
                          Problem("Entity set 'MciContext.Practitioner'  is null.");
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var practitioner = await _context.Practitioner
                .FirstOrDefaultAsync(m => m.MciIdx == id);
        ...
        [ValidateAntiForgeryToken]
        [Route("edit/{:id}")]
        public async Task<IActionResult> Edit(int id, [Bind("MciIdx,Name,Title,Location,Bio,DOB,DateCreated")] Practitioner practitioner)
        {
            if (id != practitioner.MciIdx)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!PractitionerExists(practitioner.MciIdx))
                    {
                        return NotFound();
                    }
                    else
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MciContext.Practitioner'  is null.");
            }
            var practitioner = await _context.Practitioner.FindAsync(id);
            if (practitioner != null)
            {
